...
module.exports = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, findUser, check, accessToken, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                return [3 /*break*/, 7];
            case 3:
                if (!findUser) return [3 /*break*/, 7];
                return [4 /*yield*/, bcrypt.compare(password, findUser.dataValues.password)];
            case 4:
                check = _b.sent();
                if (!!check) return [3 /*break*/, 5];
                return [2 /*return*/, res.status(200).json({ message: "password err" })];
            case 5:
