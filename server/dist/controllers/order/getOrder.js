...
var _a = require("../../models"), orderList = _a.orderList, orderNumber = _a.orderNumber, customCase = _a.customCase, phone = _a.phone;
require("dotenv").config();
module.exports = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var accessToken, userInfo, getList, data, i, tmp, j, tmp2, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                userInfo = _a.sent();
                return [4 /*yield*/, orderNumber.findAll({
