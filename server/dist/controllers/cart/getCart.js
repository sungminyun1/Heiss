...
var _a = require("../../models"), customCase = _a.customCase, cartList = _a.cartList, phone = _a.phone;
var jwt = require("jsonwebtoken");
require("dotenv").config();
module.exports = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var accessToken, userInfo, findCase, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                userInfo = _a.sent();
                return [4 /*yield*/, cartList.findAll({
                        attributes: ["quantity"],
                        include: [
                            {
                                model: customCase,
