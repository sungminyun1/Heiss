...
var _a = require("../../models"), review = _a.review, source = _a.source, users = _a.users, like = _a.like, sequelize = _a.sequelize;
var jwt = require("jsonwebtoken");
require("dotenv").config();
//! SET GLOBAL sql_mode=(SELECT REPLACE(@@sql_mode,'ONLY_FULL_GROUP_BY',''));
module.exports = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var reviewList, accessToken, userInfo, userLike_1, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, review.findAll({
                        attributes: [
                            ...
                            "desc",
                            [
                                sequelize.literal("(SELECT COUNT(reviewId) FROM likes WHERE likes.reviewId = review.id)"),
                                "like",
                            ],
                        ],
                        include: [
            ...
            case 2:
                ...
                return [4 /*yield*/, like.findAll({ where: { userId: userInfo.id } })];
            case 3:
                userLike_1 = _a.sent();
                reviewList.forEach(function (el) {
                    userLike_1.forEach(function (el2) {
